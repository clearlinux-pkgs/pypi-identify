...
Version  : 2.5.10
Release  : 53
URL      : https://files.pythonhosted.org/packages/24/7f/6812dcfa4ff7f8bd425252eb2bd4ef394477eea1424d3e09bbbfdac94e87/identify-2.5.10.tar.gz
...
%prep
%setup -q -n identify-2.5.10
cd %{_builddir}/identify-2.5.10
pushd ..
cp -a identify-2.5.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671143072
