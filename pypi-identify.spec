...
Source0  : https://files.pythonhosted.org/packages/32/c2/c7b3d6e93055f31fee10867c56e5001bd3e0aad149bc13b60c98a588115a/identify-2.5.9.tar.gz
...
%prep
%setup -q -n identify-2.5.9
cd %{_builddir}/identify-2.5.9
pushd ..
cp -a identify-2.5.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669053254
