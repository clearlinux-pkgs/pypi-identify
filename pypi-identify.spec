...
Source0  : https://files.pythonhosted.org/packages/57/76/df32f28bf83cc8f43f2f0b1a29f504ca9fb8ea811ce2d26f658a4f4667a6/identify-2.5.16.tar.gz
...
%prep
%setup -q -n identify-2.5.16
cd %{_builddir}/identify-2.5.16
pushd ..
cp -a identify-2.5.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674942707
