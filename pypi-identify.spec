...
Source0  : https://files.pythonhosted.org/packages/3b/10/22997137d75c30a20ec1a491d40a123fa3e987f005946b207614be3529d1/identify-2.5.7.tar.gz
...
%prep
%setup -q -n identify-2.5.7
cd %{_builddir}/identify-2.5.7
pushd ..
cp -a identify-2.5.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666740745
