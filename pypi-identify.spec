...
Source0  : https://files.pythonhosted.org/packages/08/36/eb2b142e245f69b0cf7b91a3f48769e414f681bd7ee04206ec0eba485e56/identify-2.5.18.tar.gz
...
%prep
%setup -q -n identify-2.5.18
cd %{_builddir}/identify-2.5.18
pushd ..
cp -a identify-2.5.18 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676391886
