...
Version  : 2.5.5
Release  : 46
URL      : https://files.pythonhosted.org/packages/60/cb/59dee3614aca9244a5955f99ba66e64366a759f7d8ea6b149cad027b91a6/identify-2.5.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/60/cb/59dee3614aca9244a5955f99ba66e64366a759f7d8ea6b149cad027b91a6/identify-2.5.5.tar.gz
...
%prep
%setup -q -n identify-2.5.5
cd %{_builddir}/identify-2.5.5
pushd ..
cp -a identify-2.5.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662480580
