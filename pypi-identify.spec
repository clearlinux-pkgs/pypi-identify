...
Source0  : https://files.pythonhosted.org/packages/29/bb/25024dbcc93516c492b75919e76f389bac754a3e4248682fba32b250c880/identify-2.6.1.tar.gz
...
%prep
%setup -q -n identify-2.6.1
cd %{_builddir}/identify-2.6.1
pushd ..
cp -a identify-2.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726364506
