...
Source0  : https://files.pythonhosted.org/packages/82/a9/3cf658d585698e8f14b09011018f4f3fd9d56b0eecefb79de89ec5cb6a92/identify-2.5.15.tar.gz
...
%prep
%setup -q -n identify-2.5.15
cd %{_builddir}/identify-2.5.15
pushd ..
cp -a identify-2.5.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674526054
