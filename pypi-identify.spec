...
Version  : 2.4.3
Release  : 25
URL      : https://files.pythonhosted.org/packages/37/50/10cd08139517bf042ed55eddc6798dd828e3bcdf2ced5d9f17828d4dd927/identify-2.4.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/37/50/10cd08139517bf042ed55eddc6798dd828e3bcdf2ced5d9f17828d4dd927/identify-2.4.3.tar.gz
...
%prep
%setup -q -n identify-2.4.3
cd %{_builddir}/identify-2.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642005235
...
cp %{_builddir}/identify-2.4.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-identify/428ea02ecbdb18e260e938e24a83f8d96b7def89
