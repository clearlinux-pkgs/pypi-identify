...
Source0  : https://files.pythonhosted.org/packages/aa/9a/83775a4e09de8b9d774a2217bfe03038c488778e58561e6970daa39b4801/identify-2.5.36.tar.gz
...
%prep
%setup -q -n identify-2.5.36
cd %{_builddir}/identify-2.5.36
pushd ..
cp -a identify-2.5.36 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713665513
