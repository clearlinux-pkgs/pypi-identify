...
Source0  : https://files.pythonhosted.org/packages/32/f4/8e8f7db397a7ce20fbdeac5f25adaf567fc362472432938d25556008e03a/identify-2.6.0.tar.gz
...
%prep
%setup -q -n identify-2.6.0
cd %{_builddir}/identify-2.6.0
pushd ..
cp -a identify-2.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720478159
