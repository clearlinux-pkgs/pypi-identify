...
Source0  : https://files.pythonhosted.org/packages/85/0d/5d875ec52e1a0b8290d5cf1995f1afc9f6830146b8c6565d800b47522e46/identify-2.5.21.tar.gz
...
%prep
%setup -q -n identify-2.5.21
cd %{_builddir}/identify-2.5.21
pushd ..
cp -a identify-2.5.21 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679064960
