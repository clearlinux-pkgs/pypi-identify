...
Version  : 2.5.2
Release  : 41
URL      : https://files.pythonhosted.org/packages/ae/14/b55f43fa6a02939763b0a2393e60e1b200d85582e6a7eb69fbc6fa186adc/identify-2.5.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/ae/14/b55f43fa6a02939763b0a2393e60e1b200d85582e6a7eb69fbc6fa186adc/identify-2.5.2.tar.gz
...
%prep
%setup -q -n identify-2.5.2
cd %{_builddir}/identify-2.5.2
pushd ..
cp -a identify-2.5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658323800
...
cp %{_builddir}/identify-2.5.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-identify/428ea02ecbdb18e260e938e24a83f8d96b7def89
cp %{_builddir}/identify-2.5.2/identify/vendor/licenses.py %{buildroot}/usr/share/package-licenses/pypi-identify/c120f330fdc22f119d76f90e375c5ee6cd7bca67
