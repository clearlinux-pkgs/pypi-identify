...
Source0  : https://files.pythonhosted.org/packages/3f/b7/931c3dbe30b5a03db56689a97d38b0692289369b32ea353a9265d318a32f/identify-2.4.1.tar.gz
...
Provides: identify
Provides: identify-python
Provides: identify-python3
...
%prep
%setup -q -n identify-2.4.1
cd %{_builddir}/identify-2.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641443928
...
cp %{_builddir}/identify-2.4.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-identify/428ea02ecbdb18e260e938e24a83f8d96b7def89
