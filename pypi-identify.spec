...
Version  : 2.4.8
Release  : 30
URL      : https://files.pythonhosted.org/packages/9e/35/1e249dd42e47c8cff94e0d5d2f3bbba24bd84e8ad4d436baaf5e42211b84/identify-2.4.8.tar.gz
Source0  : https://files.pythonhosted.org/packages/9e/35/1e249dd42e47c8cff94e0d5d2f3bbba24bd84e8ad4d436baaf5e42211b84/identify-2.4.8.tar.gz
...
%prep
%setup -q -n identify-2.4.8
cd %{_builddir}/identify-2.4.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643994739
...
cp %{_builddir}/identify-2.4.8/LICENSE %{buildroot}/usr/share/package-licenses/pypi-identify/428ea02ecbdb18e260e938e24a83f8d96b7def89
cp %{_builddir}/identify-2.4.8/identify/vendor/licenses.py %{buildroot}/usr/share/package-licenses/pypi-identify/c120f330fdc22f119d76f90e375c5ee6cd7bca67
