...
Version  : 2.5.19
Release  : 63
URL      : https://files.pythonhosted.org/packages/2d/39/743c442eecc9405d98f90a3b4308740b5c09765052e526392c307e6054a3/identify-2.5.19.tar.gz
Source0  : https://files.pythonhosted.org/packages/2d/39/743c442eecc9405d98f90a3b4308740b5c09765052e526392c307e6054a3/identify-2.5.19.tar.gz
...
%prep
%setup -q -n identify-2.5.19
cd %{_builddir}/identify-2.5.19
pushd ..
cp -a identify-2.5.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678466250
