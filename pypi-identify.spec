...
Source0  : https://files.pythonhosted.org/packages/a6/d0/069b7c1771036a51df52310a5ae17920eff94f5b3c5c19dde39c3b2aebf1/identify-2.5.13.tar.gz
...
%prep
%setup -q -n identify-2.5.13
cd %{_builddir}/identify-2.5.13
pushd ..
cp -a identify-2.5.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673540173
