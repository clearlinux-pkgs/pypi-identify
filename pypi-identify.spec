...
Source0  : https://files.pythonhosted.org/packages/82/c7/750d9467e90be6c8c8ff94a7aff029ed1229f2d53843ddf8d2b142051c88/identify-2.4.4.tar.gz
...
%prep
%setup -q -n identify-2.4.4
cd %{_builddir}/identify-2.4.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642179387
...
cp %{_builddir}/identify-2.4.4/LICENSE %{buildroot}/usr/share/package-licenses/pypi-identify/428ea02ecbdb18e260e938e24a83f8d96b7def89
