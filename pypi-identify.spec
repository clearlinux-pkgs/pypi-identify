...
Source0  : https://files.pythonhosted.org/packages/82/cb/d7ca096a5bea337db7bcca03afd18c4a7fe502ba1b0c64915950c37a5d41/identify-2.5.32.tar.gz
...
%prep
%setup -q -n identify-2.5.32
cd %{_builddir}/identify-2.5.32
pushd ..
cp -a identify-2.5.32 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700441910
