...
Source0  : https://files.pythonhosted.org/packages/e7/de/5c84c44cf63f89418927c206da12008287767fe57c95f901f47300dd17f8/identify-2.5.0.tar.gz
...
%prep
%setup -q -n identify-2.5.0
cd %{_builddir}/identify-2.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651079135
...
cp %{_builddir}/identify-2.5.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-identify/428ea02ecbdb18e260e938e24a83f8d96b7def89
cp %{_builddir}/identify-2.5.0/identify/vendor/licenses.py %{buildroot}/usr/share/package-licenses/pypi-identify/c120f330fdc22f119d76f90e375c5ee6cd7bca67
