...
Source0  : https://files.pythonhosted.org/packages/6b/c1/dcb61490b9324dd6c4b071835ce89840536a636512100e300e67e27ab447/identify-2.5.17.tar.gz
...
%prep
%setup -q -n identify-2.5.17
cd %{_builddir}/identify-2.5.17
pushd ..
cp -a identify-2.5.17 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675115861
