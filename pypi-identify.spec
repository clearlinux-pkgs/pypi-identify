...
Version  : 2.6.10
Release  : 95
URL      : https://files.pythonhosted.org/packages/0c/83/b6ea0334e2e7327084a46aaaf71f2146fc061a192d6518c0d020120cd0aa/identify-2.6.10.tar.gz
Source0  : https://files.pythonhosted.org/packages/0c/83/b6ea0334e2e7327084a46aaaf71f2146fc061a192d6518c0d020120cd0aa/identify-2.6.10.tar.gz
...
%prep
%setup -q -n identify-2.6.10
cd %{_builddir}/identify-2.6.10
pushd ..
cp -a identify-2.6.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745246516
