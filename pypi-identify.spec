...
Source0  : https://files.pythonhosted.org/packages/5f/19/f3aa63b65be4cdf23ba26984aa04cb21fa04fccfef68355919edafee025c/identify-2.5.30.tar.gz
...
%prep
%setup -q -n identify-2.5.30
cd %{_builddir}/identify-2.5.30
pushd ..
cp -a identify-2.5.30 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696261596
