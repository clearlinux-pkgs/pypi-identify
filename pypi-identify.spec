...
Source0  : https://files.pythonhosted.org/packages/a2/88/d193a27416618628a5eea64e3223acd800b40749a96ffb322a9b55a49ed1/identify-2.6.12.tar.gz
...
%prep
%setup -q -n identify-2.6.12
cd %{_builddir}/identify-2.6.12
pushd ..
cp -a identify-2.6.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748370760
